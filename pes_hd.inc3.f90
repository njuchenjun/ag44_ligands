...
subroutine evaluate_pes3(ifrac,iforce,natoms,symbols,coord,e,f) !!@@@@ rename
      implicit none
      ...
      e=totet(1,1,1)+75.540533d0 !! 2ftp min energy jyh 22/9/6
...
subroutine deallocate_pes3 !!@@@@ rename
     implicit none
       deallocate(nwave)
       deallocate(inta)
       deallocate(rs)
